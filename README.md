...
<pre>% set_clock_latency -source 1 [get_clocks clk]
% report_checks
Startpoint: B[0] (input port clocked by clk)
Endpoint: _751_ (rising edge-triggered flip-flop clocked by clk)
Path Group: clk
...
---------------------------------------------------------
   0.00    0.00   clock clk (rise edge)
   1.00    1.00   clock network delay (ideal)
   3.00    4.00 ^ input external delay
   0.00    4.00 ^ B[0] (in)
   0.28    4.28 v _600_/Y (sky130_fd_sc_hd__clkinv_1)
   0.28    4.56 ^ _608_/Y (sky130_fd_sc_hd__o221ai_1)
   0.18    4.74 v _609_/Y (sky130_fd_sc_hd__o21ai_0)
   0.41    5.14 v _612_/X (sky130_fd_sc_hd__maj3_1)
   0.35    5.49 v _615_/X (sky130_fd_sc_hd__maj3_1)
   0.13    5.62 ^ _616_/Y (sky130_fd_sc_hd__nor2_1)
   0.35    5.97 v _618_/X (sky130_fd_sc_hd__mux2_1)
   0.28    6.25 ^ _626_/Y (sky130_fd_sc_hd__a221oi_1)
   0.12    6.38 v _632_/Y (sky130_fd_sc_hd__o211ai_1)
   0.12    6.49 ^ _649_/Y (sky130_fd_sc_hd__a21oi_1)
   0.00    6.49 ^ _751_/D (sky130_fd_sc_hd__dfxtp_1)
